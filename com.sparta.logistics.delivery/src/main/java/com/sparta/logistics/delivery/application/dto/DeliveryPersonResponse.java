...
public class DeliveryPersonResponse {
    ...
    public DeliveryPersonResponse(Long id, Long userId, Long hubId, String snsId, DeliveryPersonType type, Integer sequence, LocalDateTime createdAt, String createdBy) {
        this.id = id;
        this.userId = userId;
        this.hubId = hubId;
        this.snsId = snsId;
